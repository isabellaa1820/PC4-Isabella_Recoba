...
col1.image("foto perfil.JPG", caption='Aquí puedes escribir una tiqueta debajo de la imagen', width=300)
...
texto = """
Soy Isabella Recoba estudiante de Publicidad. Me interesa la creatividad y el impacto de las ideas. Lo que más me gusta de mi carrera es la oportunidad de transformar conceptos en mensajes que conecten con las personas y generen emociones. En el futuro, me gustaría trabajar en proyectos que combinan estrategia y creatividad para marcas con propósito. En mi tiempo libre  me gusta ver contenido en redes sociales, explorar tendencias, ver documentales, y participar en diversas actividades 
.
"""
...
texto_2 = """
Cuando empecé a programar, sentí una mezcla de emoción y frustración. Todo era nuevo y a veces complicado, pero poco a poco fui entendiendo cómo funciona este lenguaje tan lógico y estructurado. La programación me ha enseñado a tener paciencia, resolver problemas desde diferentes perspectivas y valorar los detalles. Lo que más me gusta de programar es la sensación de crear algo desde cero, pero a veces puede ser un desafío cuando el código no funciona
"""
...
graficos = ['Gráfico 1', 'Gráfico 2', 'Gráfico 3']
...
if grafico_seleccionado == 'Gráfico 1':
    sidebar.markdown("<div style='text-align: justify; font-size: 20px;'>Este gráfico muestra los goles anotados por diferentes equipos italianos</div>", unsafe_allow_html=True)
    sidebar.image("imagen 1.png", caption='Gráfico 1', width=500)
    pass
elif grafico_seleccionado == 'Gráfico 2':
    sidebar.markdown("<div style='text-align: justify'>El gráfico demuestra la frecuencia mayor de palabras de un texto determinado.</div>", unsafe_allow_html=True)
    sidebar.image("imagen 2.png", caption='Gráfico 2', width=500)
    pass
elif grafico_seleccionado == 'Gráfico 3':
    sidebar.markdown("<div style='text-align: justify'>El gráfico demuestra la frecuencia con excatitud de palabras clave en un texto determinado.</div>", unsafe_allow_html=True)
    sidebar.image("imagen 3.png", caption='Gráfico 3', width=500)
    pass
